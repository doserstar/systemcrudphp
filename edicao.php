...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <div class="form-floating mb-3">
            <input type="text" class="form-control" placeholder="E-mail" name="email" value="<?php echo $linha['email']?>">
            <label for="email">E-mail</label>
        </div>
        <div class="form-floating mb-3">
            <input type="date" class="form-control" placeholder="Data de Nascimento<" name="data_nascimento" value="<?php echo $linha['data_nascimento']?>">
