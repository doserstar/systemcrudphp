    ...
    <div class="container">
        <div class="row">
            ...
            if (mysqli_query($conn, $sql)) {
                mensagemCadastro("Sucesso da Edição", 'success');
            } else {
                mensagemCadastro ("Tente novamente $nome, não foi possível concluir a alteração de dados", 'danger');
            }
            
            ?>
            <a href="pesquisa.php" class="btn-primary">Voltar ao ínicio</a>
        </div>
    </div>
